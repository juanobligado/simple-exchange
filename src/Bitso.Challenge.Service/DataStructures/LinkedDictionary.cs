...
namespace Bitso.Challenge.Service.DataStructures
{
    /// <summary>
    /// LinkedDictionary is a dictionary which preserve the order of inserting elements.
    ...
    public class LinkedDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
        {
            ...
            while (node != null)
            {
                ...
                var kvPair = new KeyValuePair<TKey, TValue>(node.Value, _valueByKey[node.Value].Value);
                yield return   kvPair;
                node = node.Next;
            }
        }
